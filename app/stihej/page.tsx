                            ...
                            <div className="text-center max-w-3xl mx-auto">
                                ...
                                <div className="flex flex-wrap justify-center gap-4">
                                    ...
                                    <div className="relative group">
                                        <a href="/bin/stihej.apk" target="_blank" className="flex items-center rounded-lg border border-white/20 backdrop-blur-sm bg-white/5 px-6 py-3 hover:bg-white/10 transition-colors ">
                                            ...
                                            <div>
                                                <div className="text-xs">Stáhnout zde</div>
