                            ...
                            <div className="text-center max-w-3xl mx-auto">
                                ...
                                <div className="flex flex-wrap justify-center gap-4">
                                    ...
                                    <div className="relative group">
                                        <div className="flex items-center rounded-lg border border-white/10 bg-white/5 px-6 py-3 opacity-50 cursor-not-allowed">
                                        ...
                                        <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-1 px-3 py-1 bg-white text-black rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none text-sm font-medium whitespace-nowrap">
                                            Již brzy!
                                        </div>
                                    </div>
                                </div>
